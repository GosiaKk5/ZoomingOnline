...
export const selectorOptions = derived(dataState, ($dataState) => {
...
export const overviewStore = derived(
  dataState,
  ($dataState) => $dataState.overviewStore,
);
export const zarrGroup = derived(
  dataState,
  ($dataState) => $dataState.zarrGroup,
);
export const isDataLoaded = derived(
  dataState,
  ($dataState) => $dataState.isLoaded,
);
...
export const showCopyLink = derived(
  uiState,
  ($uiState) => $uiState.showCopyLink,
);

export const zoomPosition = derived(
  plotState,
  ($plotState) => $plotState.zoomPosition,
);
export const zoomWidth = derived(
  plotState,
  ($plotState) => $plotState.zoomWidth,
);
export const zoomLevel = derived(
  plotState,
  ($plotState) => $plotState.zoomLevel,
);
