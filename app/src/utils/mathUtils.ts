...
export function formatFileSize(
  ...
  const formatted = math.format(math.unit(valueInBytes, "B"), {
    notation: "auto",
    precision: precision,
  });
...
export function formatFrequency(
  ...
  const formatted = math.format(math.unit(valueInHz, "Hz"), {
    notation: "auto",
    precision: precision,
  });
...
export function formatVoltage(valueInVolts: number, precision = 3): string {
  ...
  // Use math.js format with toBest to get the best SI unit
  const formatted = math.format(math.unit(valueInVolts, "V"), {
    notation: "auto",
    precision: precision,
  });
...
export function formatWithSI(value: number, unit = "", precision = 3): string {
  ...
  // Use math.js format with toBest to get the best SI unit
  const formatted = math.format(math.unit(value, unit), {
    notation: "auto",
    precision: precision,
  });
